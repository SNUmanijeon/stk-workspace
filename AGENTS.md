...
- Reuse validated code before creating another implementation. Implemented analytical helpers and validated engine models are listed in docs/CATALOG.md; other asset categories remain placeholders. Inspect existing legacy sources where available; do not treat placeholder folders as validated assets.
